    ...
    <div className="max-w-8xl mx-auto min-h-full padding-x py-6">
      ...
      <div className="flex flex-col flex-wrap justify-center gap-12 pb-6 mb-6 h-full">
        <div className="flex flex-row items-center justify-between">
          <NavLink to="/" className="flex flex-row items-center gap-1 text-secondary text-md">
        ...
        <div className="flex flex-col sm:flex-row gap-8 sm:gap-16 w-full">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-row gap-2.5 items-center">
              <div className={`h-1.5 w-1.5 ${product?.stock > 0 ? 'bg-success' : 'bg-error'} rounded-full`}></div>
              <div className="uppercase text-xs tracking-widest text-secondary">Stock: {product?.stock}</div>
            </div>

            <div className="flex flex-col gap-3">
              <div className="flex flex-row gap-2 w-full items-center">
                <div className="text-tertiary uppercase text-xs tracking-widest">Categories</div>
            ...
            <div className="flex flex-col gap-3">
              <div className="flex flex-row gap-2 w-full items-center">
                <div className="text-tertiary uppercase text-xs tracking-widest">Description</div>
                <hr className="w-full bg-primary/30"></hr>
              </div>
